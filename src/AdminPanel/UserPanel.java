...
//        setContentPane(gradient);
    ...
    public void loadUsersTable() {
        ...
        try {
            ...
            String countSql = "SELECT COUNT(*) FROM users_tbl";
...
//            String sql = "SELECT user_id, fullname, email, username, password, role from users_tbl";
            String sql = "SELECT * From users_tbl LIMIT ? OFFSET ?";
...
//                model.addRow(new Object[]{id, fullname, email, username, password, role});
    ...
    private void searchUsers () {
        ...
        try {
            conn = db.getConnection();
            String sql = "SELECT * FROM users_tbl WHERE fullname LIKE ? OR email LIKE ? OR username LIKE ? OR role LIKE ?";
            ...
            lblPageInfo.setText("Search results");
